...
class VotersThrottleRequest
{
    ...
    protected function handleRequest($request, Closure $next, array $limits)
    {
        foreach ($limits as $limit) {
            if ($this->limiter->tooManyAttempts($limit->key, $limit->maxAttempts)) {
                throw $this->buildException($request, $limit->key, $limit->maxAttempts,$limit->decayMinutes, $limit->responseCallback);
            }
     ...
     */
    protected function buildException($request, $key, $maxAttempts, $decayMinutes, $responseCallback = null)
    {
        ...
        return is_callable($responseCallback)
                    ...
                    : new ThrottleRequestsException('Anda Login Terlalu Banyak Dalam Waktu Singkat. Silahkan menunggu selama '.$decayMinutes. ' menit.', null, $headers);
    }
